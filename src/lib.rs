...
#[derive(Debug)]
pub struct OrbitGazeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl OrbitGazeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting OrbitGaze processing");
    
    let mut processor = OrbitGazeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = OrbitGazeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = OrbitGazeProcessor::new(false);
